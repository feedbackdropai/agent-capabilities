...
The base function size thresholds are defined in `code:style-guide/docs/functions.md`. The overrides below apply to the file types they specify — when a file matches a classification here, use these thresholds instead of the base.
